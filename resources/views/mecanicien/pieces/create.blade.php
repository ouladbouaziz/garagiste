...
<form action="{{ route('pieces.storem') }}" method="POST" class="m-10">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                ...
                <input class="form-control " name="referencep" ></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong>@lang('Fournisseur'):</strong>
                <input class="form-control"  name="fournisseur"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Prix') :</strong>
                <input class="form-control"  name="prix" ></input>
            </div>
        </div>
