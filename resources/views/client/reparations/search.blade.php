<div class="m-5">
    <a class="btn btn-secondary" href="{{ route('reparations.createcl') }}">@lang('Ajouter une réparation')</a>
...
<table class="table table-striped table-hover mt-10">
    ...
    @foreach ($reparations as $r)
        <tr id="row{{$r->id}}">
            ...
            <td>{{$r->clientNotes }}</td>
            <td>
                <a class="btnEdit btn  bg-blue-500 hover:bg-blue-400 text-white font-bold  px-2 border-b-4 border-blue-700 hover:border-blue-500 rounded" href="{{ route('reparations.editcl',$r->id) }}">@lang('Modifier')</a>
...
<script>
    $(document).on('click',".btnShow",function(){
        ...
        var url = '{{ route("reparations.showcl") }}';
