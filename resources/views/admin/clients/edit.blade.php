     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control"  value="{{ $clt->name }}">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                ...
                <input class="form-control"  name="telephone"   value="{{ $clt->telephone}}"></input>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 my-3">
            <div class="form-group">
                <strong >@lang('Adresse') :</strong>
                <input class="form-control"  name="adresse" value="{{ $clt->adresse }}"></input>
            </div>
        </div>
