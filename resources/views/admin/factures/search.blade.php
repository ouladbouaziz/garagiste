<div class="mt-5">
    <a class="btn btn-secondary" href="{{ route('factures.create') }}">@lang('Ajouter une facture')</a>
...
<table class="table table-striped table-hover mt-10">
    ...
    @foreach ($factures as $f)
        <tr id="row{{$f->id}}">
            ...
            <td>{{ $f->chargeSupp}}</td>
            <td>
                <a class="btnEdit btn  bg-blue-500 hover:bg-blue-400 text-white font-bold  px-2 border-b-4 border-blue-700 hover:border-blue-500 rounded" href="{{ route('factures.edit',$f->id) }}">@lang('Modifier')</a>
